...
public class ViewOrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<HoaDon> list = hoaDonDAO.listHoaDonByMaKH(taiKhoan.getTentk());
            session.setAttribute("HOA_DON", list);
        } catch (SQLException ex) {
            Logger.getLogger(ViewOrderAdminController.class.getName()).log(Level.SEVERE, null, ex);
